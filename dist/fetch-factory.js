...
var throwOnResponseError = function throwOnResponseError(response) {
...
var FetchFactory = function () {
  function FetchFactory(options) {
    ...
    this.defaultOptions.rejectOnBadResponse = (0, _lodash4.default)(options, 'rejectOnBadResponse', true);
  ...
  _createClass(FetchFactory, [{
    ...
    value: function removeNullFetchOptions(options) {
      return (0, _lodash2.default)(options, function (v, k) {
        return v != null && !(0, _lodash6.default)(v);
      });
    }
  }, {
    key: 'getResponseInterceptors',
    value: function getResponseInterceptors() {
      var responseInterceptors = (0, _lodash4.default)(this.defaultOptions, 'interceptors.response', [function (response) {
    ...
    value: function getRequestInterceptors() {
      var requestInterceptors = (0, _lodash4.default)(this.defaultOptions, 'interceptors.request', []);
...
},{"./url-parsing":3,"lodash.get":4,"lodash.isEmpty":5,"lodash.pickBy":7}],3:[function(require,module,exports){
'use strict';
...
},{"lodash.merge":6,"lodash.pickBy":7,"query-string":9,"url-pattern":11}],4:[function(require,module,exports){
(function (global){
/**
...
},{"object-assign":8,"strict-uri-encode":10}],10:[function(require,module,exports){
'use strict';
