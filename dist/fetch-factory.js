...
var FetchFactory = function () {
  ...
  _createClass(FetchFactory, [{
    ...
    value: function getResponseInterceptors() {
      var responseInterceptors = (0, _lodash6.default)(this.defaultOptions, 'interceptors.response', [throwOnResponseError, function (response) {
...
},{"./url-parsing":3,"lodash.assign":4,"lodash.get":5,"lodash.isEmpty":6,"lodash.pickBy":8}],3:[function(require,module,exports){
'use strict';
...
},{"lodash.merge":7,"lodash.pickBy":8,"query-string":10,"url-pattern":12}],4:[function(require,module,exports){
/**
