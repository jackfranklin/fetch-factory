...
var FetchFactory = (function () {
  function FetchFactory(options) {
    ...
    var templateMethods = (options.methods || []).map(function (methodName) {
      if (fetchFactoryTemplates[methodName]) {
        return _defineProperty({}, methodName, fetchFactoryTemplates[methodName]);
      } else {
        throw new Error('Unknown method ' + methodName);
      }
    }).reduce(_lodash2.default, {});

    Object.keys(templateMethods).forEach(function (method) {
      _this.defineMethod(method, templateMethods[method]);
    });
  ...
  _createClass(FetchFactory, [{
    ...
    value: function removeNullFetchOptions(options) {
      return (0, _lodash4.default)(options, function (v, k) {
        return v != null && !(0, _lodash8.default)(v);
      });
    }
  }, {
    key: 'getResponseInterceptors',
    value: function getResponseInterceptors() {
      var responseInterceptors = (0, _lodash6.default)(this.defaultOptions, 'interceptors.response', [function (response) {
    ...
    value: function getRequestInterceptors() {
      var requestInterceptors = (0, _lodash6.default)(this.defaultOptions, 'interceptors.request', []);
...
},{"./url-parsing":3,"lodash.assign":4,"lodash.get":15,"lodash.isEmpty":19,"lodash.pick":43}],3:[function(require,module,exports){
'use strict';
...
function constructUrl(urlBase) {
  ...
  var placeholderParams = placeholders.reduce(function (obj, key) {
    return (0, _lodash4.default)(obj, _defineProperty({}, key, params[key] || ''));
  }, {});
  ...
  var queryParams = (0, _lodash2.default)(params, function (val, paramKey) {
...
},{"lodash.merge":26,"lodash.pick":43,"query-string":55,"url-pattern":57}],4:[function(require,module,exports){
/**
...
},{"lodash._baseassign":5,"lodash._createassigner":7,"lodash.keys":11}],5:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._basecopy":6,"lodash.keys":11}],6:[function(require,module,exports){
/**
...
},{"lodash._baseget":16,"lodash._topath":17}],16:[function(require,module,exports){
/**
...
},{"lodash.isarray":18}],18:[function(require,module,exports){
...
},{"lodash.isarguments":20,"lodash.isarray":21,"lodash.isfunction":22,"lodash.isstring":23,"lodash.keys":24}],20:[function(require,module,exports){
...
},{"dup":11,"lodash._getnative":25,"lodash.isarguments":20,"lodash.isarray":21}],25:[function(require,module,exports){
...
},{"lodash._arraycopy":27,"lodash._arrayeach":28,"lodash._createassigner":29,"lodash.isarguments":34,"lodash.isarray":35,"lodash.isplainobject":36,"lodash.istypedarray":38,"lodash.keys":39,"lodash.toplainobject":41}],27:[function(require,module,exports){
/**
...
},{"dup":7,"lodash._bindcallback":30,"lodash._isiterateecall":31,"lodash.restparam":32}],30:[function(require,module,exports){
...
},{"lodash._basefor":37,"lodash.isarguments":34,"lodash.keysin":40}],37:[function(require,module,exports){
/**
...
arguments[4][11][0].apply(exports,arguments)
},{"dup":11,"lodash._getnative":33,"lodash.isarguments":34,"lodash.isarray":35}],40:[function(require,module,exports){
/**
...
},{"lodash.isarguments":34,"lodash.isarray":35}],41:[function(require,module,exports){
/**
 * lodash 3.0.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._basecopy":42,"lodash.keysin":40}],42:[function(require,module,exports){
...
},{"lodash._baseflatten":44,"lodash._bindcallback":47,"lodash._pickbyarray":48,"lodash._pickbycallback":49,"lodash.restparam":54}],44:[function(require,module,exports){
/**
...
},{"lodash._basefor":50,"lodash.keysin":51}],50:[function(require,module,exports){
arguments[4][37][0].apply(exports,arguments)
},{"dup":37}],51:[function(require,module,exports){
arguments[4][40][0].apply(exports,arguments)
},{"dup":40,"lodash.isarguments":52,"lodash.isarray":53}],52:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
